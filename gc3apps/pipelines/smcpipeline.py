#! /usr/bin/env python
#
#   smcpipeline.py -- SMC pre-processing script
#
...
class SMCPipeline(StagedTaskCollection):
    """
    Staged collection:
    ...
    def __init__(self, data_location, dataset_name, instrument, config_file, **extra_args):
        ...
        if self.cfg['sMC'].has_key('derived_subfolders'):
            self.subfolders += self.cfg['sMC']['derived_subfolders'].values()
